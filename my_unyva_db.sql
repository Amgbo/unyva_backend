...
CREATE TABLE IF NOT EXISTS students (
  ...
  role VARCHAR(20) DEFAULT 'buyer_seller',student_id	first_name	last_name	email	phone	gender	hall_of_residence	date_of_birth	profile_picture	id_card	password	is_verified	verification_token	role	delivery_code	is_delivery_approved	university	program	graduation_year	rating	total_ratings	room_number	is_active_seller	is_active_service_provider	seller_rating	seller_review_count	service_provider_rating	service_review_count	delivery_rating	delivery_review_count	total_transactions	last_active	profile_completion_score	preferred_contact_method	created_at	registration_complete	has_paid	payment_date
